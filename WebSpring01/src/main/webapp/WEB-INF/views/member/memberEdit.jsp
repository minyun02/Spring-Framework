...
<div class="container">
	...
	<form method="post" action="/home/memberEditOk">
		...
		관심분야 : <input type="checkbox" name="interestArr" value="코딩" <c:forEach var="i" items="${vo.interestArr}"><c:if test="${i=='코딩'}">checked</c:if></c:forEach>>코딩
				<input type="checkbox" name="interestArr" value="컴퓨터" <c:forEach var="i" items="${vo.interestArr}"><c:if test="${i=='컴퓨터'}">checked</c:if></c:forEach>>컴퓨터
				...
				<input type="checkbox" name="interestArr" value="인라인" <c:forEach var="i" items="${vo.interestArr}"><c:if test="${i=='인라인'}">checked</c:if></c:forEach>>인라인
				...
				<input type="checkbox" name="interestArr" value="게임" <c:forEach var="i" items="${vo.interestArr}"><c:if test="${i=='게임'}">checked</c:if></c:forEach>>게임<br>
