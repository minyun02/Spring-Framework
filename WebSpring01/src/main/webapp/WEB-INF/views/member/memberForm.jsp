...
<div class="container">
	...
	<form method="post" action="/home/memberOk">
		...
		관심분야 : <input type="checkbox" name="interestArr" value="코딩">코딩
				<input type="checkbox" name="interestArr" value="컴퓨터">컴퓨터
				...
				<input type="checkbox" name="interestArr" value="게임">게임<br>
